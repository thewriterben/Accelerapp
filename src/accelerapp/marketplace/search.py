...
class TemplateSearch:
    ...
    def search(
        ...
        if query:
            ...
            results = [
                ...
                or query_lower in t.author.lower()
            ]
    ...
    def get_popular(self, limit: int = 10) -> List[TemplateMetadata]:
        ...
        """
        sorted_templates = sorted(self.templates, key=lambda t: t.downloads, reverse=True)
    ...
    def get_top_rated(self, limit: int = 10) -> List[TemplateMetadata]:
        ...
        """
        sorted_templates = sorted(self.templates, key=lambda t: t.rating, reverse=True)
        return sorted_templates[:limit]
    ...
    def get_recent(self, limit: int = 10) -> List[TemplateMetadata]:
        ...
        sorted_templates = sorted(
            self.templates, key=lambda t: t.updated_at or t.created_at, reverse=True
        )
        return sorted_templates[:limit]

...
class SSOManager:
    ...
    def register_provider(
        self, provider_id: str, provider_type: str, name: str, config: Dict[str, Any]
    ) -> SSOProvider:
        """
    ...
    def authenticate_saml(
        self, provider_id: str, saml_response: str, relay_state: Optional[str] = None
    ) -> Optional[SSOSession]:
        """
        ...
        return self._create_session(
            user_id, provider_id, {"relay_state": relay_state, "auth_method": "saml"}
        )

    def authenticate_oauth2(
        self, provider_id: str, authorization_code: str, redirect_uri: str
    ) -> Optional[SSOSession]:
        """
        ...
        return self._create_session(
            user_id, provider_id, {"redirect_uri": redirect_uri, "auth_method": "oauth2"}
        )

    def authenticate_oidc(self, provider_id: str, id_token: str) -> Optional[SSOSession]:
        """
        ...
        return self._create_session(user_id, provider_id, {"auth_method": "oidc"})

    def _create_session(
        self, user_id: str, provider_id: str, attributes: Dict[str, Any]
    ) -> SSOSession:

...
class RBACManager:
    ...
    def _initialize_default_roles(self) -> None:
        ...
        self.create_role(
            "admin", "Administrator", "Full system access", list(self.permissions.keys())
        )
        ...
        self.create_role(
            "viewer", "Viewer", "Read-only access", ["read_devices", "read_logs", "read_analytics"]
        )

    def create_permission(
        self, permission_id: str, resource: str, action: str, description: str
    ) -> Permission:
        """
        ...
        permission = Permission(
            permission_id=permission_id, resource=resource, action=action, description=description
        )
    ...
    def get_user_roles(self, user_id: str) -> List[Role]:
        ...
        return [
            self.roles[role_id] for role_id in self.user_roles[user_id] if role_id in self.roles
        ]

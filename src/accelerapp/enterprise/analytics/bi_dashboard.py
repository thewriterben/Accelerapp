...
class BIDashboard:
    ...
    def record_metric(
        self, metric_name: str, value: float, dimensions: Optional[Dict[str, str]] = None
    ) -> None:
        """
    ...
    def get_metric_summary(
        self, metric_name: str, start_time: Optional[str] = None, end_time: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        if not data_points:
            return {"metric": metric_name, "count": 0, "summary": {}}
    ...
    def get_dashboard_overview(self) -> Dict[str, Any]:
        ...
        """
        overview = {"total_metrics": len(self.metrics), "metrics": []}
    ...
    def get_time_series(
        self, metric_name: str, interval_minutes: int = 60, limit: int = 24
    ) -> List[Dict[str, Any]]:
        """
        ...
        for bucket_time in sorted(time_buckets.keys(), reverse=True)[:limit]:
            ...
            time_series.append(
                {"timestamp": bucket_time, "value": sum(values) / len(values), "count": len(values)}
            )
    ...
    def compare_metrics(
        ...
        """
        comparison = {"metrics": [], "comparison_period": {"start": start_time, "end": end_time}}

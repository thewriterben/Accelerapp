...
class TenantManager:
    ...
    def create_resource(
        self, tenant_id: str, resource_type: str, data: Dict[str, Any]
    ...
    def get_tenant_resources(
        self, tenant_id: str, resource_type: Optional[str] = None
    ) -> List[TenantResource]:
        """
    ...
    def _check_resource_limit(self, tenant_id: str, resource_type: str) -> bool:
        ...
        current_count = sum(
            1 for r in self.resources.get(tenant_id, []) if r.resource_type == resource_type
        )

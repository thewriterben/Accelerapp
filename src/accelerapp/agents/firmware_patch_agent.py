...
class FirmwarePatchAgent(BaseAgent):
    ...
    def _apply_patch(self, spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.log_action(
            "patch_applied",
            {"device_id": device_id, "patch_id": patch_id, "new_version": new_version},
        )
    ...
    def _rollback_patch(self, spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        rollback_stages = [
            {
                "stage": "backup_current",
                "status": "completed",
                "message": "Current state backed up",
            },
            {
                "stage": "restore_backup",
                "status": "completed",
                "message": "Previous firmware restored",
            },
        ...
        self.log_action(
            "patch_rollback",
            {"device_id": device_id, "from_version": current_version, "to_version": old_version},
        )
    ...
    def _validate_patch(self, spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        validations = [
            {
                "test": "firmware_integrity",
                "status": "passed",
                "message": "Firmware integrity verified",
            },
            {"test": "boot_sequence", "status": "passed", "message": "Boot sequence normal"},
            {
                "test": "hardware_compatibility",
                "status": "passed",

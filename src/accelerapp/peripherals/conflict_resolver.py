...
class PeripheralConflictResolver:
    ...
    def _suggest_stm32_alternatives(
        self, peripheral_config: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    def _suggest_esp32_alternatives(
        self, peripheral_config: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    def optimize_pin_mapping(self) -> Dict[str, Any]:
        ...
        optimization = {"status": "analyzed", "suggestions": [], "conflicts_resolved": 0}
        ...
        for conflict in report["conflicts"]:
            ...
            if peripheral_type:
                alternatives = self.suggest_alternatives(
                    {"id": peripheral_id, "type": peripheral_type}
                )

                if alternatives:
                    optimization["suggestions"].append(
                        {"conflict": conflict, "alternatives": alternatives}
                    )

...
class FirmwareManager:
    ...
    def download_firmware(
        self, version: str, hardware_model: HardwareModel, force: bool = False
    ) -> Optional[Path]:
        """
        ...
        logger.warning(
            f"Firmware download not yet implemented for {version} on {hardware_model.value}"
        )
    ...
    def flash_firmware(
        self, device_port: str, firmware_path: Path, erase_flash: bool = False
    ) -> bool:
        """

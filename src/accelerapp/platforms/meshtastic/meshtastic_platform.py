...
class MeshtasticPlatform(BasePlatform):
    ...
    def _generate_device_config(self, spec: Dict[str, Any], output_dir: Path) -> Path:
        ...
        config = {
            ...
            "channels": spec.get("channels", [{"index": 0, "name": "Primary", "psk": "AQ=="}]),
        }
...
"""
    ...
    def flash_firmware(
        self, device_port: str, hardware_model: HardwareModel, version: Optional[str] = None
    ) -> bool:
        """
    ...
    def perform_ota_update(
        self, device_id: str, firmware_path: Path, method: OTAMethod = OTAMethod.WIFI
    ) -> bool:
        """

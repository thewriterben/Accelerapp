...
class OTAController:
    ...
    def check_update_available(
        self, current_version: str, hardware_model: str
    ...
    def _ota_wifi(self, device_ip: str, firmware_path: Path, progress_callback=None) -> bool:
    ...
    def _ota_ble(self, device_address: str, firmware_path: Path, progress_callback=None) -> bool:
    ...
    def create_ota_package(
        self, firmware_path: Path, output_path: Path, metadata: Optional[Dict[str, Any]] = None
    ) -> bool:
        """

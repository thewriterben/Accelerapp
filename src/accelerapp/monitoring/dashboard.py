...
class MonitoringDashboard:
    ...
    def add_alert_rule(
        self, name: str, condition: str, severity: str, notification_channels: List[str]
    ) -> Dict[str, Any]:
        """
        Add an alert rule.
    ...
    def get_alert_history(
        self, time_window: int = 24, device_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        Get alert history.
        ...
        alerts = [a for a in self.alerts if datetime.fromisoformat(a["timestamp"]) > cutoff]
    ...
    def register_notification_channel(
        ...
        return {"status": "success", "channel": self.notification_channels[channel_id]}
    ...
    def _get_alert_trend_data(self) -> Dict[str, Any]:
        ...
        return {"status": "success", "widget_type": "alert_trend", "data": trend_data}
    ...
    def _get_severity_distribution(self) -> Dict[str, Any]:
        ...
        return {"status": "success", "widget_type": "severity_distribution", "data": distribution}
    ...
    def _get_top_alert_devices(self, limit: int = 10) -> Dict[str, Any]:
        ...
        top_devices = sorted(device_counts.items(), key=lambda x: x[1], reverse=True)[:limit]

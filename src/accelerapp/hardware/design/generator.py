...
from .board_support import BoardSpecification, BoardSupportMatrix, ESP32BoardType
...
class EnclosureGenerator:
    ...
    def _select_material(
        ...
        if budget_constraint == "under_25_usd" and len(recommended) > 0:
            ...
            return min(recommended, key=lambda m: self._material_properties[m]["cost_per_kg"])

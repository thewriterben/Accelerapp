...
class SharedContext:
    ...
    def __init__(self):
        ...
        self._locks: Dict[str, threading.RLock] = {
            scope.value: threading.RLock() for scope in ContextScope
        }
    ...
    def delete(
        self, key: str, scope: ContextScope = ContextScope.GLOBAL, scope_id: Optional[str] = None
    ) -> bool:
        """
    ...
    def get_all(
        self, scope: ContextScope = ContextScope.GLOBAL, scope_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def clear(self, scope: Optional[ContextScope] = None, scope_id: Optional[str] = None) -> None:
        """
        Clear context data.
    ...
    def _get_scope_key(self, scope: ContextScope, scope_id: Optional[str]) -> str:
        """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        for scope, scope_data in self.contexts.items():
            ...
            stats["scope_stats"][scope] = {"namespaces": len(scope_data), "total_keys": total_keys}

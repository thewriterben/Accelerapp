...
class DigitalTwinManager:
    ...
    def get_all_states(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        return {device_id: twin.get_current_state() for device_id, twin in self.twins.items()}
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "connected_twins": sum(
                1 for twin in self.twins.values() if twin.current_state.get("connected", False)
            ),

...
class ConfigurationManager:
    ...
    def _load_from_env(self) -> None:
        ...
        if os.getenv("STRUCTURED_LOGGING"):
            monitoring_overrides["structured_logging"] = (
                os.getenv("STRUCTURED_LOGGING").lower() == "true"
            )
        ...
        if os.getenv("ENABLE_ENCRYPTION"):
            security_overrides["enable_encryption"] = (
                os.getenv("ENABLE_ENCRYPTION").lower() == "true"
            )

...
class DeviceIdentityManager:
    ...
    def rotate_identity(self, device_id: str, validity_days: int = 365) -> Optional[DeviceIdentity]:
        """
        ...
        new_identity = self.create_identity(device_info, validity_days, old_identity.metadata)
